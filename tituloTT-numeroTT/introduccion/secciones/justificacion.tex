...
\begin{enumerate}
	...
	\begin{table}
		...
		\begin{tabular}{|p{3cm}|p{6cm}|p{3cm}|}
			...
			\hline
			Sense 4 Care & Desarrolla dispositivos para monitorear a personas de la tercera edad que en caso de caídas, manda un mensaje de alerta a sus familiares & \euro149.59 \\
			\hline
