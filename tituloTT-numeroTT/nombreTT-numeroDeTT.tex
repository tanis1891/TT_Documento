...
\begin{document}
	...
	\include{advertencia} %Incluir advertencia del archivo (advertencia.tex)
	\include{agradecimientos} %Incluir agradecimientos del archivo (agradecimientos.tex)
    ...
    \input{./analisis/analisis}
	   \input{./analisis/secciones/tema1}
	   \input{./analisis/secciones/tema2}
	   \input{./analisis/secciones/tema3}
	   \input{./analisis/secciones/tema4}
	   \input{./analisis/secciones/tema5}
	   \input{./analisis/secciones/tema6}
	   \input{./analisis/secciones/tema7}
	   \input{./analisis/secciones/tema8}
	   \input{./analisis/secciones/tema9}
%	   \input{./analisis/secciones/tema10}
%	   \input{./analisis/secciones/tema11}
%	   \input{./analisis/secciones/tema12}
\end{document}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%    FIN DEL DOCUMENTO    %%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
